...
export class CallDataComponent implements OnInit {
  ...
  init(){
    this.pregressNotes =this.formBuilder.group({
      ...
      IsHouseBusinessApartment:['',Validators.required],
      CallBackNumber:['',Validators.required],
      YourName:['',Validators.required],
      WhatHappened:['',Validators.required],
      AreYouAtThatLocation:['',Validators.required],
      WhenDidThisHappen:['',Validators.required],
      IsweaponsInvolved:['',Validators.required],
      IsCallingAboutViolent:['',Validators.required],
      IsHistoryViolence:['',Validators.required],
      IsPersonBeginningWithRace:['',Validators.required],
      PersonName:['',Validators.required],
      HowOldAreThey:['',Validators.required],
      WhatAreTheyWearing:['',Validators.required],
      IsAnyOneDanger:['',Validators.required],
      IsNeedMedicalAttention:['',Validators.required],
      IsMentalHealthDiagnosis:['',Validators.required],
      IsTakingAnyMedication:['',Validators.required],
      LocationCrisisAgain:['',Validators.required],
      NameMCT:['',Validators.required],
