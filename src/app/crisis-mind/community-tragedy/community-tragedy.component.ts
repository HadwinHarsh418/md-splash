...
@Component({
  selector: 'app-community-tragedy',
  templateUrl: './community-tragedy.component.html',
  styleUrls: ['./community-tragedy.component.scss']
})
export class CommunityTragedyComponent implements OnInit {
  ...
  init(){
    this.pregressNotes =this.formBuilder.group({
      ...
      ParticipantName4:['',Validators.required],
      crisScene:['',Validators.required],
      //ProcedureCode1:[''],
      //location_required:[''],
      //hdnInsuranceType:[''],
     // selectAuthNumber:[''],
