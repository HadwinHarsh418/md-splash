...
@Component({
  selector: 'app-mobile-response-report',
  templateUrl: './mobile-response-report.component.html',
  styleUrls: ['./mobile-response-report.component.scss']
})
export class MobileResponseReportComponent implements OnInit {
