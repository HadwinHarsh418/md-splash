...
@Component({
  selector: 'app-problem-check',
  templateUrl: './problem-check.component.html',
  styleUrls: ['./problem-check.component.scss']
})
export class ProblemCheckComponent implements OnInit {
