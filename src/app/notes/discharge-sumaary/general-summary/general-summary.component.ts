...
export class GeneralSummaryComponent implements OnInit {
  ...
  init(){
    this.generalForm =this.formBuilder.group({
      ...
      WishingDeadNo:[''],
      HarmOthersNo:[''],
      PreviousTherapyCounsellingNo:[''],
      HospitalizedForEmotionalNo:[''],
      IsTreatmentHelpfulNo:[''],
      HospitalizedForAbuseYes:[''],
      Customerisinjailorprison:[''],
      Customerdeceased:[''],
      Customernolongermeetsnecessarymedicalcriteria:[''],
      Consumerlackofparticipationinprogram:[''],
      Customerisnolongereligibleforservices:[''],
      Dischargereasonunknown:[''],
      Programsdeterminationtodiscontinueservices:[''],
      ...
      ProblemInCurrentRelationshipYes:[''],
      ISstressInPreviousMarriage_Yes:[''],
      ProblemInPreviousRelationshipYes:[''],
      Grade:[''],
      Degree:[''],
