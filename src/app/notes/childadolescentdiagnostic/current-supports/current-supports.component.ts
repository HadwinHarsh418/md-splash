...
@Component({
  selector: 'app-current-supports',
  templateUrl: './current-supports.component.html',
  styleUrls: ['./current-supports.component.scss']
})
export class CurrentSupportsComponent implements OnInit {
