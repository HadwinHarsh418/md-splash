...
@Component({
  selector: 'app-functionsandsymptoms',
  templateUrl: './functionsandsymptoms.component.html',
  styleUrls: ['./functionsandsymptoms.component.scss']
})
export class FunctionsandsymptomsComponent implements OnInit {
