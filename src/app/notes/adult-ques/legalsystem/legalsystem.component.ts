...
@Component({
  selector: 'app-legalsystem',
  templateUrl: './legalsystem.component.html',
  styleUrls: ['./legalsystem.component.scss']
})
export class LegalsystemComponent implements OnInit {
  ...
  init(){
    this.generalForm =this.formBuilder.group({
      ...
      jailorPrison:['',Validators.required],
      currentlyEmployed:['',Validators.required],
      beenEmployed:['',Validators.required],
      satisftWithJob:['',Validators.required],
      doYouSmoke:['',Validators.required],
      followingTobaccoProduct:['',Validators.required],
      Zip_code:[''],
      HomePhone:[''],
      CellPhone:[''],
      DischargingProvider:[''],
