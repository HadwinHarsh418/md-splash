...
@Component({
  selector: 'app-psychiatric-symptoms',
  templateUrl: './psychiatric-symptoms.component.html',
  styleUrls: ['./psychiatric-symptoms.component.scss']
})
export class PsychiatricSymptomsComponent implements OnInit {
