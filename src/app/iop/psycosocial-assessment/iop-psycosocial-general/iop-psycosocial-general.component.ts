...
@Component({
  selector: 'app-iop-psycosocial-general',
  templateUrl: './iop-psycosocial-general.component.html',
  styleUrls: ['./iop-psycosocial-general.component.scss']
})
export class IopPsycosocialGeneralComponent implements OnInit {
